...
### Clifford torus construction

The standalone S³ scene divides the Clifford torus into eight congruent
minimal patches generated by half-turns about the geodesic edges of one Lawson
quadrilateral. A two-color checkerboard makes the reflection tiling visible;
patches sharing an edge always have different colors. Two overlapping
antipodal charts cover the complete surface and support continuous camera
movement across S³.
